        ...
        <div className={`h-full w-[280px] md:w-[320px] shadow-2xl flex flex-col p-6 overflow-hidden backdrop-blur-2xl ${isDark ? 'bg-zinc-950/95 border-l border-zinc-800 text-white' : 'bg-white/95 border-l border-gray-100 text-gray-900'}`}>
          ...
          {deferredPrompt && (
            <button 
              ...
              className={`w-full py-4 rounded-2xl flex items-center justify-center gap-3 mb-6 font-black text-[10px] uppercase tracking-[0.2em] shadow-xl transition-all active:scale-95 bg-emerald-600 text-white hover:bg-emerald-500`}
            >
